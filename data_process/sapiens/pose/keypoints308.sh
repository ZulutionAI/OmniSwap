...
OUTPUT="xxx/skeleton_sapiens_308"
...
DETECTION_CONFIG_FILE='data_process/sapiens/pose/mmdetection_cfg/rtmdet_m_640-8xb32_coco-person_no_nms.py'
...
##-------------------------------------inference-------------------------------------
RUN_FILE='data_process/sapiens/pose/demo_vis.py'
...
# IMAGE_LIST="/mnt2/zhenghaoyu/code/mdm_o/dataset/dataset_split/dataset_img_path/vcg_0.txt"
python ../collect_data.py --input $INPUT --output_root $OUTPUT --process_type pose || exit 1
